...
**Archivo:** [`postman/GYM_Microservices.postman_collection.json`](https://github.com/Microservices-Gym-Exercise/Docs/blob/main/postman/GYM%20Microservices.postman_collection.json)
